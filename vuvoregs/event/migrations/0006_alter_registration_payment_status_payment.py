# Generated by Django 5.1.7 on 2025-03-18 22:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('event', '0005_alter_athlete_bib_number'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='payment_status',
            field=models.CharField(choices=[('not_paid', 'Not Paid'), ('paid', 'Paid'), ('failed', 'Failed')], default='not_paid', max_length=20),
        ),
