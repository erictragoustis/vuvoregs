...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='athlete',
            options={'ordering': ['-registration__created_at']},
        ),
        migrations.AddField(
            model_name='registration',
            name='payment',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='registration', to='event.payment'),
        ),
    ]
